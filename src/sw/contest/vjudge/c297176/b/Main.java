package sw.contest.vjudge.c297176.b;
...
public class Main {
    private static final int[] parents = new int[105];
    private static final int[][] edges = new int[5000][3];
    private static final int[] isVisited = new int[5000];
